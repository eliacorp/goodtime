...
.directive('a24logoDirective', function() {
  return {
    restrict: 'E',
    templateUrl: 'views/components/icon/a24_logo.html',
    replace: true,
...
.directive('elaralogoDirective', function() {
  return {
    restrict: 'E',
    templateUrl: 'views/components/icon/elara_logo.html',
    replace: true
  };
})


.directive('rhealogoDirective', function() {
  return {
    restrict: 'E',
    templateUrl: 'views/components/icon/rhea_logo.html',
    replace: true,
    link: function(scope, elem, attrs) {

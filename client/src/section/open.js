...
.controller('openCtrl', ['$rootScope', '$scope','$window','anchorSmoothScroll', ($rootScope, $scope, $window, anchorSmoothScroll)=>{
...
var lastScrollPosition = window.pageYOffset;
          ...
          angular.element($window).bind("scroll", function() {
            ...
            var requestId = "swjhs";
              ...
              //       for (var i in $scope.opentextA){
              //         if((window.pageYOffset>$scope.opentextA[i].point)&&(window.pageYOffset<($scope.opentextA[i].point+50))){
              //           $scope.opentextA[i].opacity = opacity;
              //         }else if(window.pageYOffset>=($scope.opentextA[i].point+50)){
              //           $scope.opentextA[i].opacity=1;
              //         }
              //       }
              //     }
